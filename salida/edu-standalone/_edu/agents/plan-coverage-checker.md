...
```xml
<agent id="edu.plan-coverage-checker" name="Verificador de Cobertura" title="Verificador del Plan Mínimo" icon="📊" capabilities="coverage matrix, risk alerting, immutable plan enforcement">
