...
- **Actions:**
  ...
  2. Si la carpeta no existe → avisarle al docente; verificar también si hay PDFs sueltos en `{project-root}/material/` (raíz) y ofrecerlos como material general; continuar sin material de referencia si no hay nada (no es bloqueante)
