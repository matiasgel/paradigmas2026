...
**Sugerencia de estrategia:** Si la tabla de derivación está correcta, el árbol debe tener el mismo número de pasos. Cada fila de la tabla corresponde a una aplicación de regla, que a su vez corresponde a un nivel del árbol. Chequea que:
