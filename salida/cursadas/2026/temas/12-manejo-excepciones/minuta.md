...
> **Pipeline:** v3 · Generado: 2026-06-04
...
## BLOQUE A — Fundamentos conceptuales (35 min)
...
## BLOQUE B — TypeScript: imperativo y funcional (35 min)
...
**Conceptos clave:** propagación, call stack, información en el handler  
**Preguntas anticipadas:**  
...
**Conceptos clave:** jerarquía de Error, campos custom, captureStackTrace, instanceof  
**Preguntas anticipadas:**  
...
- Conexión curricular: "Este tipo es la mónada Either. En Haskell es `Either a b`. En fp-ts es `Either`. La idea es la misma."
...
**Conceptos clave:** errors as values, retorno múltiple, %w wrapping, errors.As, defer  
**Preguntas anticipadas:**  
...
## BLOQUE D — Agéntica y cierre (13 min)
...
**Conceptos clave:** context poisoning, typed errors MCP, withRetry, isRetryable, observabilidad  
**Preguntas anticipadas:**  
