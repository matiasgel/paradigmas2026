...
```xml
<agent id="edu.test-runner" name="(motor interno)" title="Motor de Testing Pedagógico" icon="🧪" capabilities="simulation batch execution, score generation, FAQ compilation" internal="true">
