...
2. Ask the user:
   ...
   >
   > **Referencias disponibles:** Multimedia Learning (Mayer/Fiorella), Cognitive Load (Sweller/Chen), WCAG 2.2/3.0, FSRS v4, Bloom/Haladyna, Learning Analytics, CS Education/GitHub, Slide Composition, Adaptive Learning/ITS, MCP Protocol.
   >
