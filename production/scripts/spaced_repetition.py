#!/usr/bin/env python3
"""
spaced_repetition.py ÔÇö Motor de Spaced Repetition FSRS v4 para EDU (S2.1)
...
# FSRS v4 ÔÇö FREE SPACED REPETITION SCHEDULER
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# Basado en: Ye (2023-2024) "A Stochastic Shortest Path Algorithm for
# Optimizing Spaced Repetition Scheduling" ÔÇö Open Spaced Repetition

# Par├ímetros por defecto (FSRS-4.5 defaults)
FSRS_PARAMS = {
...
class FSRSCard:
    ...
    def retrievability(self, elapsed_days: float) -> float:
        """Calcula la probabilidad de recuperaci├│n (curva del olvido)."""
        if self.stability <= 0 or elapsed_days <= 0:
            return 1.0
        return math.exp(math.log(0.9) * elapsed_days / self.stability)

    def next_interval(self) -> float:
        """Calcula el intervalo ├│ptimo para mantener desired_retention."""
    ...
    def update_after_review(self, score: float) -> None:
        ...
        score: 0.0-1.0 donde 1.0 = record├│ perfectamente
        """
        w = FSRS_PARAMS
        self.review_count += 1
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# BASE DE DATOS (SQLite ÔÇö CREATE IF NOT EXISTS)
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def get_card_state(conn: sqlite3.Connection, course_id: str,
    ...
    """Recupera el ├║ltimo estado FSRS para un topic, o crea uno nuevo."""
    row = conn.execute(
...
def generate_calendar(conn: sqlite3.Connection, project_root: Path,
    ...
    now = datetime.now()
    lines = [
        f"# Calendario de Repasos ÔÇö {course_id}",
        f"**Generado:** {now.strftime('%Y-%m-%d %H:%M')}",
        f"**Algoritmo:** FSRS v4 (Ye 2023-2024)",
        f"**Retenci├│n objetivo:** {FSRS_PARAMS['desired_retention'] * 100:.0f}%",
        "",
    ]

    if not topics:
        lines.append("Ôä╣´©Å No se encontraron temas. Crear temas primero con `/edu-design-topic`.")
        return "\n".join(lines) + "\n"

    # Pr├│ximos repasos pendientes
    rows = conn.execute(
    ...
    if never_reviewed:
        lines.extend([
            "## ­ƒåò Temas Sin Repaso",
            "",
            "| Tema | Primer repaso sugerido |",
            "|------|-----------------------|",
        ])
        for t in never_reviewed:
            # Sugerir 3 d├¡as despu├®s de la clase (heur├¡stica)
...
def generate_review_slides(conn: sqlite3.Connection, course_id: str,
    ...
    content = f"""# Slides de Repaso ÔÇö {topic_id}
**Repaso #{card.review_count + 1}** | Retrievability estimada: {r:.0%}

---

## Filmina de Repaso 1 ÔÇö Recuperaci├│n Activa (Socr├ítica)

**Tipo:** pregunta-socr├ítica  
**T├¡tulo:** ┬┐Qu├® recuerdan de {topic_id.replace('-', ' ')}?  
**Body:** T├│mense 60 segundos para escribir los 3 conceptos principales del tema.

> **Nota para el docente:** Esta filmina activa la recuperaci├│n activa (testing effect).
> No dar la respuesta inmediatamente ÔÇö esperar a que los alumnos generen sus propias respuestas.

---

## Filmina de Repaso 2 ÔÇö Conexi├│n con Nuevo Material

**Tipo:** concepto-abstracto  
**T├¡tulo:** Conexi├│n: {topic_id.replace('-', ' ')} ÔåÆ Tema actual  
**Body:** [Completar con la conexi├│n concreta entre este tema y el material nuevo]

> **Nota para el docente:** Interleaving ÔÇö mezclar temas viejos con nuevos
> mejora la retenci├│n a largo plazo (Roediger & Butler, 2011).

---

## Filmina de Repaso 3 ÔÇö Aplicaci├│n R├ípida

**Tipo:** demo  
**T├¡tulo:** Mini-ejercicio rel├ímpago (2 min)  
**Body:** [Completar con un ejercicio corto que aplique conceptos del tema]

> **Nota para el docente:** Desirable difficulty ÔÇö el ejercicio debe ser
> ligeramente dif├¡cil para maximizar la retenci├│n (Bjork & Bjork, 2011).
"""
    return content
...
def main() -> None:
    ...
    rec_parser.add_argument("--score", type=float, required=True,
                            help="Score 0.0-1.0 (1.0 = record├│ todo)")
    ...
    try:
        if args.command == "generate":
            ...
            print(f"Ô£à Calendario generado: {output_path}")
            ...
            for topic_id in topics:
                ...
                if review_md:
                    ...
                    print(f"  ­ƒôï Slides de repaso: {review_path}")
            ...
            print(f"Ô£à Repaso registrado: {args.topic} (score={args.score:.0%})")
            print(f"   Pr├│ximo repaso: {next_date} (en {interval} d├¡as)")
            print(f"   Estabilidad: {card.stability:.2f} | Dificultad: {card.difficulty:.2f}")

        elif args.command == "status":
            topics = discover_topics(project_root, args.course)
            if not topics:
                print(f"Ôä╣´©Å No se encontraron temas para {args.course}.")
                sys.exit(0)

            print(f"Estado de repasos ÔÇö {args.course}")
            print(f"{'Tema':<30} {'Repasos':<10} {'├Ültimo':<12} {'Pr├│ximo':<12} {'Score':<8}")
            print("-" * 72)
            ...
            for topic_id in topics:
                ...
                if card.review_count > 0:
                    ...
                    next_r = row[1] if row else "ÔÇö"
                    print(
                        f"{topic_id:<30} {card.review_count:<10} "
                        f"{card.last_review or 'ÔÇö':<12} {next_r:<12} "
                        f"{avg_score:.0%}"
                    )
                else:
                    print(f"{topic_id:<30} {'0':<10} {'ÔÇö':<12} {'ÔÇö':<12} {'ÔÇö':<8}")
