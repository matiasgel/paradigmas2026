#!/usr/bin/env python3
"""
universal_kg_builder.py ÔÇö Universal CS Knowledge Graph Builder (S13.2)
======================================================================
Construye un KG universal de CS desde fuentes abiertas:
  - ACM/IEEE CC2023 (14 KAs, 52 KUs) ÔÇö embebido
...
# ACM/IEEE CC2023 DATA (embebido ÔÇö no requiere scraping)
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
# Prerequisitos inter-KA basados en CC2023 ┬º3
...
class UniversalKGBuilder:
    ...
    def ingest_mit_ocw(self, max_courses: int = 50) -> int:
        """Ingesta t├¡tulos de cursos MIT OCW (requiere red)."""
        try:
            import requests
        except ImportError:
            print("ÔÜá´©Å  requests no instalado ÔÇö omitiendo MIT OCW")
            return 0
        ...
        try:
            ...
            print("ÔÜá´©Å  No se pudo acceder a MIT OCW ÔÇö modo offline")
            return 0
    ...
    def build(self, output_path: Path) -> Path:
        ...
        print(f"Ô£à KG universal generado: {output_path}")
...
def merge_with_course_kg(universal_path: Path, course_kg_path: Path) -> None:
    ...
    print(f"Ô£à KG del curso fusionado con KG universal ÔåÆ {course_kg_path}")
...
def main() -> int:
    ...
    if args.command == "build":
        ...
        if not course_kg_path.exists():
            print(f"ÔØî KG del curso no encontrado: {course_kg_path}")
            return 1
        if not universal_path.exists():
            print(f"ÔØî KG universal no encontrado: {universal_path}. Ejecute 'build' primero.")
            return 1
