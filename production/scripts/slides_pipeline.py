#!/usr/bin/env python3
"""
EDU Slides Pipeline ÔÇö M├│dulo EDU (v4 ÔÇö Schema-Driven)
======================================================
Pipeline can├│nico: filminas.md ÔåÆ plan JSON v3 ÔåÆ assets ÔåÆ Google Slides.

Fases:
    1. plan     ÔÇö Parsea filminas.md y genera plan-filminas-{tema}.json
    2. validate ÔÇö Valida plan JSON contra contratos v3
    3. assets   ÔÇö Genera im├ígenes con Gemini, renderiza tablas como PNG (matplotlib),
                  sube todo a Google Drive.
    4. publish  ÔÇö Crea la presentaci├│n en Google Slides desde el plan.
...
Archivos de configuraci├│n (en la ra├¡z del proyecto):
  _edu/secrets.local.yaml              ÔÇö google_credentials_path + gemini_api_key
  _edu/slides-config.yaml              ÔÇö sistema de dise├▒o
  _edu/schemas/schema-registry.json    ÔÇö mapeos y enums (fuente ├║nica de verdad)
...
# Dimensiones est├índar 16:9 en EMU (English Metric Units)
SLIDE_W = 9_144_000
SLIDE_H = 5_143_500
MARGIN = 457_200      # ~0.5 pulgada
TITLE_H = 760_000  # alto reservado para t├¡tulo, compacto para maximizar espacio ├║til de contenido
LOGO_CLEAR = 700_000  # y m├¡nimo para no solapar el logo institucional del template
TITLE_SAFE_X = 1_520_000
BOTTOM_CLEAR = 760_000
TABLE_BOTTOM_CLEAR = 1_520_000
EMU_PER_PT = 12_700

# Directrices de layout por tipo ÔÇö fuente can├│nica: schema-registry.json
...
def _override_maps_from_registry(registry: dict) -> None:
    """Sobreescribe LAYOUT_MAP desde el schema registry (fuente ├║nica de verdad)."""
    global LAYOUT_MAP
...
def _image_layer_from_registry(registry: dict) -> dict[str, str]:
    """Extrae mapeo tipo ÔåÆ image_layer desde el registry."""
    type_layout_map = registry.get("type_layout_map", {})
    return {
...
# Geometr├¡a de zonas en EMU: (x, y, width, height)
...
# find_project_root, load_yaml, load_json, save_json ÔÇö importados de pipeline_common
...
def _strip_markdown(text: str) -> str:
    ...
    text = re.sub(r'`([^`]+)`', r'\1', text)
    # Eliminar links [texto](url) ÔåÆ solo texto
    text = re.sub(r'\[([^\]]+)\]\([^)]+\)', r'\1', text)
    # Eliminar > blockquotes
    text = re.sub(r'^>\s*', '', text, flags=re.MULTILINE)
    # Eliminar ## headings al inicio de l├¡nea
...
def _parse_schema_directive(line: str, schema: dict[str, Any]) -> dict[str, Any] | None:
    stripped = line.strip()
    # Soporta directivas envueltas en backticks: `@tipo: portada` ÔåÆ @tipo: portada
...
def _looks_like_ascii_diagram(code_text: str) -> bool:
    ...
    if not lines or len(lines) > 6:
        return False
    joined = "\n".join(lines)
    has_ascii_connectors = any(token in joined for token in ("ÔåÆ", "ÔåÉ", "Ôåæ", "Ôåô", "ÔöÇÔöÇ", "|", "/", "\\"))
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 1 ÔÇö PARSEO DE FILMINAS.MD
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ

def parse_filminas(filminas_path: Path, schema: dict[str, Any] | None = None) -> list[dict]:
    """Lee filminas.md y extrae cada slide como estructura sem├íntica completa."""
    if schema is None:
...
def _finalize_slide(raw: dict, schema: dict[str, Any]) -> dict:
    """Parsea raw_lines en bloques sem├ínticos: subtitle, body_blocks, code_blocks, tables."""
    lines       = raw["raw_lines"]
    title       = raw["raw_title"]
    subtitle    = ""
    ...
    while i < len(lines):
        ...
        # ÔöÇÔöÇ Bloque de c├│digo ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        ...
        # ÔöÇÔöÇ Tabla Markdown ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        ...
        # ÔöÇÔöÇ Saltar secciones del documento que no pertenecen a la slide ÔöÇÔöÇÔöÇ
        if any(pattern.match(line) for pattern in ignored_section_patterns):
            i += 1
            continue

        # ÔöÇÔöÇ Headings Markdown ÔåÆ subt├¡tulo o texto destacado ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        ...
        # ÔöÇÔöÇ Separadores / l├¡neas vac├¡as ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        if not line.strip() or line.strip() == "---":
            i += 1
            continue

        # ÔöÇÔöÇ Texto / lista ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        block_lines = [line]
        i += 1
        while i < len(lines):
            nxt = lines[i]
        ...
        if re.match(r"^(?:[-*ÔÇó]|\d+\.)", first):
            ordered = bool(re.match(r"^\s*\d+[.)]\s+", first))
            items = []
            for bl in block_lines:
                # Strip bullet prefix correctamente: "- text", "* text", "ÔÇó text", "1. text"
                stripped = re.sub(r'^\s*[-*ÔÇó]\s+', '', bl)
...
def validate_filminas_contract(slides: list[dict], schema: dict[str, Any], filminas_path: Path) -> None:
    errors: list[str] = []
    if not slides:
        errors.append("No se detectaron filminas con el patr├│n can├│nico ### [F-XX] T├¡tulo")
    ...
    if errors:
        raise ValueError(
            "Contrato de filminas inv├ílido en "
            f"{filminas_path}:\n- " + "\n- ".join(errors)
        )
...
def _detect_type(slide_id: str, title: str, code_blocks, tables, directives: dict[str, Any] | None = None, body_blocks: list | None = None) -> str:
    ...
    if num == 0:
        return "portada"
    if code_blocks:
        # Si hay cuerpo sustancial (listas o varios bloques de texto), usar dise├▒o mixto
        if body_blocks:
            substantial = sum(
                len(b.get("items", []))
                if b.get("type") == "list"
    ...
    if tables:
        return "tabla"
    tl = title.lower()
    if any(k in tl for k in ["demo ", "en vivo", "pr├íctica", "ejercicio"]):
        return "demo"
    if any(k in tl for k in ["cierre", "adelanto", "mapa de la materia", "fin de"]):
        return "cierre"
    if any(k in tl for k in ["timeline", "l├¡nea del tiempo", "historia"]):
        return "timeline"
    if any(k in tl for k in ["┬┐", "pregunta", "reflexi├│n", "socr├ít"]):
        return "socratica"
...
def _image_safety_rules() -> str:
    return (
        "Sin texto, sin letras, sin c├│digo, sin etiquetas ni f├│rmulas. "
        "Solo elementos visuales: objetos, iconos, escenas o diagramas mudos. "
        "Estilo vectorial limpio, fondo claro, acad├®mico."
    )


def _append_image_guardrails(prompt: str, config: dict) -> str:
    base = re.sub(r"\s+", " ", prompt).strip().rstrip(".")
    style = f"Alta resoluci├│n, {_palette_prompt_fragment(config)}. {_image_safety_rules()}"
    return f"{base}. {style}"
...
def _image_prompt(slide: dict, config: dict) -> str:
    ...
    title = _strip_markdown(str(slide.get("title", "")).strip()) or "lenguajes de programaci├│n"

    if stype == "portada":
        prompt = (
            f"Portada acad├®mica universitaria: bloques geom├®tricos y flechas representando etapas de un compilador, "
            f"aula y materiales de estudio. Tema: {title}"
        )
    elif stype == "cierre":
        prompt = (
            f"Composici├│n visual de s├¡ntesis: ├írbol sint├íctico, bloques de pipeline y s├¡mbolo de completitud. "
            f"Tema: {title}"
        )
    elif stype == "socratica":
        prompt = (
            f"Escena de debate acad├®mico: dos caminos visuales opuestos con ├¡conos contrastantes. "
            f"Tema: {title}"
        )
    elif stype == "diagrama":
        prompt = (
            f"Infograf├¡a t├®cnica con cajas y flechas representando un pipeline o flujo de procesamiento. "
            f"Tema: {title}"
        )
    elif stype == "timeline":
        prompt = (
            f"L├¡nea de tiempo con hitos visuales concretos, ├¡conos mudos, sin texto. "
            f"Tema: {title}"
        )
    else:
        prompt = (
            f"Ilustraci├│n t├®cnica universitaria: objetos y escenas propios del dominio de compiladores, "
...
def generate_plan(filminas_path: Path, config: dict, template_id: str, registry: dict | None = None) -> dict:
    """Fase 1: filminas.md ÔåÆ plan-filminas-{tema}.json (formato v3 unificado)."""
    print("­ƒôï Fase 1 ÔÇö Generando plan desde filminas.md ÔÇª")
    ...
    # Budget de im├ígenes: m├íximo 12 por presentaci├│n
    ...
    print(f"  Ô£à {len(slides)} filminas procesadas, {img_count} im├ígenes planificadas.")
    return plan


def validate_publish_artifacts(plan_path: Path) -> Result[dict]:
    """Valida el plan JSON v3. Retorna Result con el plan si es v├ílido."""
    if not plan_path.exists():
        return Result.fail(f"Falta el plan de publicaci├│n: {plan_path}")

    plan = load_json(plan_path)
    errors: list[str] = []

    if not plan.get("meta") or not plan.get("slides"):
        errors.append(f"Plan inv├ílido: {plan_path} debe incluir 'meta' y 'slides'.")
    ...
    if missing_meta:
        errors.append(
            f"Plan inv├ílido: faltan campos en meta: {', '.join(sorted(missing_meta))}"
        )
    ...
    for slide in plan.get("slides", []):
        ...
        if img.get("layer") in ("background", "content") and not str(img.get("prompt", "")).strip():
            errors.append(
                f"Plan inv├ílido: {slide_id} requiere image.prompt no vac├¡o para layer='{img['layer']}'."
            )
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 2 ÔÇö GENERACI├ôN DE ASSETS
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def _gemini_image(prompt: str, output_path: Path, api_key: str) -> bool:
    ...
    try:
        ...
        print(f"    ÔÜá´©Å  Imagen 4.0 fall├│ para {output_path.name}: {exc}")
        return False


def _render_table_png(table_md: str, output_path: Path, config: dict) -> bool:
    """Renderiza tabla Markdown como PNG acad├®mico usando matplotlib."""
    try:
        import matplotlib
        matplotlib.use("Agg")
        ...
        print("    ÔÜá´©Å  matplotlib no instalado ÔÇö omitiendo imagen de tabla")
        return False
    except Exception as exc:
        print(f"    ÔÜá´©Å  Error renderizando tabla: {exc}")
        return False


def _upload_drive(drive_svc, file_path: Path, folder_id: str | None) -> str | None:
    """Sube un archivo a Drive, lo hace p├║blico y devuelve el file_id."""
    try:
        ...
        time.sleep(0.3)   # margen para propagaci├│n de permisos
        return fid
    except Exception as exc:
        print(f"    ÔÜá´©Å  Error subiendo {file_path.name} a Drive: {exc}")
        return None
...
def generate_assets(
    ...
    """Fase 2: Genera im├ígenes Gemini, renderiza tablas y sube todo a Drive."""
    print("\n­ƒÄ¿ Fase 2 ÔÇö Generando assets ÔÇª")
    ...
    for slide in plan["slides"]:
        ...
        # ÔöÇÔöÇ Imagen (v3 unificado) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        img = _get_slide_image(slide)
        layer = img.get("layer", "none")
        if layer != "none" and img.get("prompt") and img.get("local_asset"):
            lp = topic_folder / img["local_asset"]
            if not lp.exists():
                print(f"  ­ƒû╝´©Å  Generando imagen ({layer}) para {slide['id']} ÔÇª")
        ...
        # ÔöÇÔöÇ Tablas como PNG ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        updated_ta = []
        for ta in slide.get("table_assets") or []:
            ta = dict(ta)
            lp = topic_folder / ta["local_asset"]
            if not lp.exists() and ta.get("table_markdown"):
                print(f"  ­ƒôè Renderizando tabla {slide['id']}-table-{ta['index'] + 1} ÔÇª")
    ...
    plan = dict(plan)
    plan["slides"] = updated
    print("  Ô£à Assets completados.")
    return plan


# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 3 ÔÇö PUBLICACI├ôN EN GOOGLE SLIDES
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def _build_slide_requests(slide: dict, config: dict, page_id: str, insert_idx: int) -> list:
    ...
    # ÔöÇÔöÇ 1. Crear slide en blanco ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    reqs.append({
        "createSlide": {
            "objectId":         page_id,
    ...
    # ÔöÇÔöÇ 2. Fondo de slide ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    reqs.append({
    ...
    def add_bg_overlay(zone: str, opacity: float = 0.6) -> None:
        """Rect├íngulo blanco semitransparente encima de la imagen de fondo."""
        geo = ZONES.get(zone)
        if not geo:
            return
        x, y, w, h = geo
    ...
    # ÔöÇÔöÇ 3. Imagen (v3 unificado) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    img = _get_slide_image(slide)
    ...
    # ÔöÇÔöÇ 4. Imagen de contenido ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if img_layer == "content" and img_drive_id:
        img_zone = layout.get("image", "right-half")
        if img_zone != "none":
            add_image(_drive_url(img_drive_id), img_zone)

    # ÔöÇÔöÇ 5. Tablas (preferir nativas cuando entren bien) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ 6. T├¡tulo ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ 7. Subt├¡tulo (portada) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ 8. Cuerpo (texto + listas) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ 9. C├│digo ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
def publish_slides(plan: dict, config: dict, creds: Credentials, topic_folder: Path) -> str:
    """Fase 3: Crea presentaci├│n en Google Slides desde el plan. Devuelve la URL."""
    print("\n­ƒÜÇ Fase 3 ÔÇö Publicando en Google Slides ÔÇª")
    ...
    print(f"  Copiando plantilla {template_id} ÔÇª")
    pres_id = _copy_template(drive_svc, template_id, title)
    print(f"  Presentaci├│n creada: {pres_id}")
    ...
    BATCH = 50
    # Google Slides API: 60 write requests/min/user ÔåÆ spacing de 1.1 s entre lotes
    BATCH_DELAY = 1.1
    MAX_RETRIES = 5
    total = len(all_reqs)
    failed_batches: list[str] = []
    n_batches = (total + BATCH - 1) // BATCH
    print(f"  Enviando {total} requests en {n_batches} lotes de {BATCH} (delay={BATCH_DELAY}s) ÔÇª")
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            try:
                ...
                if "429" in err_str and attempt < MAX_RETRIES:
                    ...
                    print(f"  ÔÅ│ {label} ÔÇö rate limit, reintento {attempt}/{MAX_RETRIES - 1} en {wait:.0f}s ÔÇª")
                    time.sleep(wait)
                else:
                    print(f"  ÔÜá´©Å  Error en {label}: {exc}")
    ...
    if failed_batches:
        print(f"  ÔÜá´©Å  {len(failed_batches)} lote(s) fallaron ÔÇö la presentaci├│n qued├│ incompleta:")
        for msg in failed_batches:
            print(f"     ÔÇó {msg}")
        raise RuntimeError("Publish incompleto: uno o m├ís lotes de Google Slides fallaron")

    # ÔöÇÔöÇ Limpieza: elimina textos del template que quedaron en los slides ÔöÇ
    _TEMPLATE_TEXTS = {
    ...
    try:
        ...
        if del_reqs:
            ...
            print(f"  ­ƒùæ´©Å  Eliminados {len(del_reqs)} textos residuales del template.")
    except Exception as exc:
        print(f"  ÔÜá´©Å  No se pudo limpiar textos del template: {exc}")
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="EDU Slides Pipeline ÔÇö Plan JSON v3 ÔåÆ Assets ÔåÆ Google Slides",
    ...
    if not topic_folder.is_dir():
        print(f"ÔØî El directorio no existe: {topic_folder}")
        sys.exit(1)

    project_root = find_project_root(topic_folder)

    # ÔöÇÔöÇ Cargar schema registry y sobreescribir mapeos ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    registry = load_registry(project_root)
    if registry:
        _override_maps_from_registry(registry)
        print("  Ô£ô Schema registry cargado ÔÇö mapeos actualizados desde _edu/schemas/schema-registry.json")
    else:
        print("  ÔÜá´©Å  Schema registry no encontrado ÔÇö usando mapeos por defecto")
    ...
    # ÔöÇÔöÇ Buscar plan JSON v3 ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ --regen-plan: regenerar plan desde filminas.md ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if args.regen_plan:
        filminas_path = topic_folder / "filminas.md"
        if not filminas_path.exists():
            print(f"ÔØî No se encontr├│ filminas.md en {topic_folder}")
            sys.exit(1)
        template_id = config.get("template_id", "")
        if not template_id:
            print("ÔØî template_id no configurado en slides-config.yaml")
            sys.exit(1)
        plan_path = topic_folder / "slides" / f"plan-filminas-{topic_folder.name}.json"
        new_plan = generate_plan(filminas_path, config, template_id, registry=registry)
        save_json(plan_path, new_plan)
        print(f"  ­ƒôä Plan regenerado: {plan_path.relative_to(project_root)}")
        print(f"     {new_plan['meta']['total_slides']} filminas, {new_plan['meta']['images_planned']} im├ígenes planificadas.")
        print("\nÔ£à Plan listo. Ejecutar con --assets-only para generar im├ígenes.")
        return

    # ÔöÇÔöÇ Fase 1: Validar plan JSON v3 ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    result = validate_publish_artifacts(plan_path)
    if not result.is_ok:
        for err in result.errors:
            print(f"ÔØî {err}")
        print("   Ejecutar primero el prompt/agente que genera el plan de publicaci├│n.")
        sys.exit(1)

    plan = result.unwrap()
    print(f"  ­ƒôä Plan cargado desde: {plan_path.relative_to(project_root)}")
    if args.plan_only:
        print("\nÔ£à Plan validado. Pod├®s ejecutar sin --plan-only para generar assets y publicar.")
        return

    # ÔöÇÔöÇ Autenticar con Google ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    secrets = load_yaml(secrets_path) if secrets_path.exists() else {}
    gemini_key   = secrets.get("gemini_api_key", "")
    creds = _get_creds(secrets_path, token_path)

    # ÔöÇÔöÇ Fase 2: Generar assets ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if not args.publish_only:
        plan = generate_assets(plan, config, creds, gemini_key, topic_folder)
        save_json(plan_path, plan)
        print(f"  ­ƒôä Plan actualizado con drive_ids: {plan_path.relative_to(project_root)}")
        if args.assets_only:
            print("\nÔ£à Assets generados. Ejecutar con --publish-only para publicar.")
            return

    # ÔöÇÔöÇ Fase 3: Publicar ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
