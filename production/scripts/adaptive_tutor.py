#!/usr/bin/env python3
"""
adaptive_tutor.py ÔÇö Adaptive Tutor: KST + BKT + Director (S13.3)
==================================================================
Tutor adaptativo sin curr├¡cula fija. Integra KSTEngine para
...
class StudentState:
    """Gesti├│n simple del estado de mastery del estudiante."""
...
class AdaptiveTutor:
    """Tutor adaptativo: estado ÔåÆ concepto frontera KST ÔåÆ contenido on-demand."""
    ...
    def recommend_next(self) -> dict:
        ...
        if not nxt:
            return {"concept": None, "message": "┬íFelicitaciones! Dominaste todos los conceptos."}
    ...
    def update_after_assessment(self, concept: str, correct: bool) -> None:
        """Actualiza estado BKT despu├®s de una evaluaci├│n."""
