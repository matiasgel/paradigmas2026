#!/usr/bin/env python3
"""
EDU Slides Pipeline ÔÇö Test Runner de Integraci├│n
=================================================
Ejecuta el pipeline completo de creaci├│n de filminas como test de integraci├│n,
...
Estructura del reporte generado:
  {project-root}/reporte/test{YYYYMMDD_HHMMSS}/
    filminas.md           ÔÇö copia del filminas.md usado como entrada
    slides-config.yaml    ÔÇö copia del slides-config.yaml utilizado
    test-meta.yaml        ÔÇö metadatos del run (timings, resultados, errores)
    tema-test/            ÔÇö carpeta de trabajo del pipeline
      slides/             ÔÇö artefactos generados
        plan-filminas-tema-test.json
        assets/           ÔÇö im├ígenes IA + tablas PNG generadas
          F-00-bg.png
          F-01-bg.png
          ...
    filminas/             ÔÇö capturas de pantalla de Google Slides
      filmina_00.png
      filmina_01.png
      ...
    report.html           ÔÇö informe visual con thumbnails y estado de cada fase

Fases del test:
  1. Setup        ÔÇö copia artefactos de referencia, crea estructura
    2. Semantic UX  ÔÇö valida render sem├íntico Markdown ÔåÆ Google Slides
    3. Plan         ÔÇö ejecuta Fase 1 del pipeline (parse filminas.md ÔåÆ plan YAML)
    4. Assets       ÔÇö ejecuta Fase 2 del pipeline (Imagen 4.0 + tablas matplotlib)
    5. Publish      ÔÇö ejecuta Fase 3 del pipeline (crea presentaci├│n en Google Slides)
    6. Screenshots  ÔÇö descarga capturas de slides via Google Slides API
    7. Report       ÔÇö genera report.html + test-meta.yaml

Uso:
  python test_pipeline.py                          # test completo
  python test_pipeline.py --plan-only              # solo Fase 1 (sin Google APIs)
  python test_pipeline.py --no-images              # sin generaci├│n de im├ígenes IA
...
Requiere:
  ...
  - _edu/slides-config.yaml (sistema de dise├▒o)
...
def _err(msg: str)  -> None: print(f"\033[0;31mÔØî {msg}\033[0m")
def _info(msg: str) -> None: print(f"   Ôä╣  {msg}")
...
def find_project_root(start: Path) -> Path:
    ...
    raise FileNotFoundError(f"Ra├¡z del proyecto no encontrada desde {start}")
...
def validate_semantic_rendering(project_root: Path, meta: dict) -> bool:
    ...
    # Fixture de slide para test de bullets ÔÇö formato v3 unificado
    bullet_slide = {
        "id": "F-10",
    ...
    if not inserted or any("ÔÇó" in text or "- " in text for text in inserted):
        findings.append("Las listas siguen public├índose con prefijos literales en el texto")
    ...
    inline_slide = {
        ...
        "body_blocks": [
            ...
            {"type": "text", "content": "Texto con **├®nfasis**, *it├ílica*, `codigo()` y [link](https://example.com)."},
        ],
        "tables": [],
        "table_assets": [],
        "code_blocks": [],
    ...
    if any(">" in text for text in inserted):
        findings.append("Los blockquotes siguen public├índose con '>' literal")
    if not any(style["style"].get("bold") for style in styled_ranges):
        findings.append("No se detect├│ estilo bold para **texto** inline")
    if not any(style["style"].get("italic") for style in styled_ranges):
        findings.append("No se detect├│ estilo italic para *texto* inline")
    if not any(style["style"].get("fontFamily") == "Roboto Mono" for style in styled_ranges):
        findings.append("No se detect├│ estilo monoespaciado para inline code")
    if not any(style["style"].get("link", {}).get("url") == "https://example.com" for style in styled_ranges):
        findings.append("No se detect├│ link real para enlaces Markdown")

    table_slide = {
        "id": "F-12",
        "type": "tabla",
        "title": "Tabla legible",
        "subtitle": "Comparaci├│n breve",
    ...
    if not any("createTable" in req for req in reqs):
        findings.append("Las tablas cortas no se est├ín renderizando como tablas nativas")

    long_title_slide = {
        "id": "F-13",
        "type": "concepto-abstracto",
        "title": "Von Neumann ÔåÆ c├│digo imperativo (correspondencia directa)",
        "subtitle": "Subt├¡tulo breve",
        "body_blocks": [],
        "tables": [],
        "table_assets": [],
        "code_blocks": [],
    ...
    if not any(style.get("fontSize", {}).get("magnitude", 0) < 36 for style in title_styles):
        findings.append("Los t├¡tulos largos no est├ín reduciendo tama├▒o para entrar mejor en slide")
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 1 ÔÇö Setup del directorio de reporte
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def setup_test_dir(
    ...
    # Copiar artefactos de referencia al directorio ra├¡z del test
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 2 ÔÇö Ejecutar pipeline (plan + assets + publish)
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def run_pipeline(
    ...
    if not pipeline.exists():
        # Modo standalone: el script est├í en el mismo directorio
        pipeline = Path(__file__).parent / "slides_pipeline.py"
    if not pipeline.exists():
        meta["errors"].append("slides_pipeline.py no encontrado")
        return False, None

    # ÔöÇÔöÇ Fase Plan ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if reuse_plan:
        ...
        if not ok:
            ...
            meta["errors"].append(f"Plan fall├│: {out[-500:]}")
            _err(f"Plan fall├│ ({elapsed}s)")
            print(out[-1000:])
            return False, None
    ...
    # ÔöÇÔöÇ Fase Assets ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if not no_images:
        t0 = time.time()
        ...
        if not ok:
            ...
            _warn(f"Assets fallaron ({elapsed}s) ÔÇö continuando con publish...")
        else:
            meta["phases"]["assets"]["status"] = "ok"
            _ok(f"Assets generados ({elapsed}s)")
    else:
        # En modo --no-images anulamos las im├ígenes para que el test sea barato.
        import json as _json
        plan_path = topic_folder / "slides" / f"plan-filminas-{TOPIC_NAME}.json"
        with plan_path.open("r", encoding="utf-8") as _f:
            plan_data = _json.load(_f)
        ...
        if not ok:
            meta["phases"]["assets"]["status"] = "error"
            meta["phases"]["assets"]["output"] = out[-2000:]
            meta["errors"].append(f"Assets sin im├ígenes fallaron: {out[-500:]}")
            _warn(f"Assets de tablas fallaron ({elapsed}s) ÔÇö continuando con publish...")
        else:
            meta["phases"]["assets"]["status"] = "ok"
            _ok(f"Assets de tablas generados ({elapsed}s)")

    # ÔöÇÔöÇ Fase Publish ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    t0 = time.time()
    ...
    if not ok:
        ...
        meta["errors"].append(f"Publish fall├│: {out[-500:]}")
        _err(f"Publish fall├│ ({elapsed}s)")
        print(out[-1500:])
        return False, None
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 3 ÔÇö Screenshots via Google Slides API
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def screenshot_slides(
    ...
    try:
        ...
        meta["errors"].append(f"Error obteniendo presentaci├│n: {exc}")
        _err(f"No se pudo obtener la presentaci├│n: {exc}")
        return 0
    ...
    for idx, slide in enumerate(slides, start=1):
        ...
        try:
            ...
            if not content_url:
                raise ValueError("contentUrl vac├¡o en respuesta de thumbnail")
            ...
            count += 1
            print(f"  ­ƒô© Captura {idx:02d}/{total} Ô£ô", end="\r")
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 4 ÔÇö Generar informe HTML
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def generate_report(
    ...
    status_html = "Ô£à PASS" if err_count == 0 else f"ÔÜá´©Å {err_count} errores"

    # ÔöÇÔöÇ Galer├¡a de capturas ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ Assets generados ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ Tabla de fases ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    def phase_row(name: str, label: str) -> str:
        ph = meta["phases"].get(name, {})
        st = ph.get("status", "pending")
        el = ph.get("elapsed_s", 0)
        icon = {"ok": "Ô£à", "error": "ÔØî", "pending": "ÔÅ│",
                "skipped_reuse": "ÔÅ¡´©Å", "skipped_no_images": "ÔÅ¡´©Å"}.get(st, "ÔØô")
        extra = ""
        if name == "plan":
            extra = f" ÔÇö {ph.get('slides', '?')} filminas"
        if name == "publish" and ph.get("presentation_url"):
            extra = f' ÔÇö <a href="{ph["presentation_url"]}" target="_blank">abrir Ôåù</a>'
        if name == "screenshots":
            extra = f" ÔÇö {ph.get('count', 0)} capturas"
        return f"<tr><td>{icon} {label}</td><td>{el}s{extra}</td></tr>"

    phases_html = (
        phase_row("semantic",    "Fase 1 ÔÇö Validaci├│n sem├íntica UX") +
        phase_row("plan",        "Fase 2 ÔÇö Plan YAML") +
        phase_row("assets",      "Fase 3 ÔÇö Assets (IA + tablas)") +
        phase_row("publish",     "Fase 4 ÔÇö Publicar Google Slides") +
        phase_row("screenshots", "Fase 5 ÔÇö Screenshots")
    )

    # ÔöÇÔöÇ Errores ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    errs_html = ""
    if meta["errors"]:
...
<head>
  ...
  <title>Test Pipeline ÔÇö {ts}</title>
  <style>
    :root {{
...
<body>
<header>
  <h1>­ƒº¬ Test Pipeline ÔÇö Filminas</h1>
  <p>{ts} ┬À {status_html} ┬À {ok_count} fases OK ┬À {total_s:.1f}s total</p>
</header>
<main>
  ...
  <h2>Fases de ejecuci├│n</h2>
  <table>
    <thead><tr><th>Fase</th><th>Resultado</th></tr></thead>
    <tbody>{phases_html}</tbody>
  </table>

  {"<p><a href='" + pres_url + "' target='_blank'>­ƒöù Abrir presentaci├│n en Google Slides Ôåù</a></p>" if pres_url else ""}

  {errs_html}

  <h2>­ƒô© Capturas de filminas ({n_shots})</h2>
  <div class="gallery">{gallery_html}</div>

  <h2>­ƒû╝´©Å Assets generados ({len(asset_items)})</h2>
  <div class="gallery">{assets_html}</div>

  <h2>­ƒôï Datos del test</h2>
  <table>
    <tr><th>Par├ímetro</th><th>Valor</th></tr>
    <tr><td>ID test</td><td>{ts}</td></tr>
    <tr><td>Iniciado</td><td>{meta['started_at']}</td></tr>
    <tr><td>Finalizado</td><td>{meta.get('finished_at', 'ÔÇö')}</td></tr>
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# FASE 5 ÔÇö Copiar assets finales al directorio del reporte
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ

def copy_assets_to_report(test_dir: Path, topic_folder: Path, meta: dict) -> None:
    """Copia los assets generados (PNG) al directorio ra├¡z del reporte para f├ícil acceso."""
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="EDU Slides Pipeline ÔÇö Test de integraci├│n completo",
    ...
    parser.add_argument(
        "--no-images",
        action="store_true",
        help="Omitir generaci├│n de im├ígenes IA (Imagen 4.0) en Fase 2",
    )
    parser.add_argument(
        "--reuse-plan",
        metavar="PATH",
    ...
    parser.add_argument(
        ...
        help=f"Int├®rprete Python a usar (por defecto: {sys.executable})",
    )
    args = parser.parse_args(argv)

    project_root = find_project_root(Path(__file__).parent)

    # ÔöÇÔöÇ Resolver rutas de entrada ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    if not args.plan_only and not secrets_path.exists():
        _err("Falta _edu/secrets.local.yaml ÔÇö ejecutar /edu-setup-apis primero")
        sys.exit(1)
...
Ôòæ   ­ƒº¬ EDU Slides Pipeline ÔÇö Test de Integraci├│n             Ôòæ
ÔòÜÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòØ""")
    ...
    # ÔöÇÔöÇ Paso 1: Setup ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ Paso 2: Validaci├│n sem├íntica UX ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    _step(2, "Validando render sem├íntico Markdown ÔåÆ Slides")
    t0 = time.time()
    semantic_ok = validate_semantic_rendering(project_root, meta)
    meta["phases"]["semantic"]["elapsed_s"] = round(time.time() - t0, 1)
    if semantic_ok:
        _ok("Validaci├│n sem├íntica OK")
    else:
        _err("Validaci├│n sem├íntica fall├│")

    # ÔöÇÔöÇ Paso 3: Pipeline ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    _step(3, "Ejecutando pipeline (Plan ÔåÆ Assets ÔåÆ Publish)")
    ...
    # ÔöÇÔöÇ Paso 4: Screenshots ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    if pres_id and not args.plan_only:
        ...
        _step(4, "Screenshots ÔÇö omitido (plan-only)")
    else:
        meta["phases"]["screenshots"]["status"] = "skipped_no_pres"
        _step(4, "Screenshots ÔÇö omitido (sin presentaci├│n disponible)")

    # ÔöÇÔöÇ Paso 5: Copiar assets ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    _step(5, "Copiando assets al directorio de reporte")
    copy_assets_to_report(test_dir, topic_folder, meta)

    # ÔöÇÔöÇ Paso 6: Generar reporte ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    _step(6, "Generando informe HTML")
    report_path = generate_report(test_dir, topic_folder, meta, args.plan_only)

    # ÔöÇÔöÇ Resumen final ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    total_elapsed = round(time.time() - t_total, 1)
    err_count = len(meta["errors"])

    print(f"""
ÔòöÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòù
Ôòæ   Test completado en {total_elapsed:.1f}s{"" if err_count == 0 else f" ÔÇö ÔÜá´©Å {err_count} errores"}
ÔòÜÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòØ
...
""")
    if meta.get("phases", {}).get("publish", {}).get("presentation_url"):
        _ok(f"Presentaci├│n: {meta['phases']['publish']['presentation_url']}")
