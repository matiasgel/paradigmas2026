#!/usr/bin/env python3
"""
cognitive_budget.py ÔÇö Calculador de presupuesto cognitivo por clase (S4.2)
...
COGNITIVE_WEIGHT = {
    # Tipo ÔåÆ peso base (1-10) donde 10 = m├íxima demanda cognitiva
    "portada": 1,
    ...
    "tabla-mixta": 7,
    "diagrama": 5,
    "socratica": 3,      # Attention reset ÔÇö reduce carga
    "demo": 4,           # Pr├íctica activa ÔÇö moderado
    "cierre": 2,
    "timeline": 4,
}
...
MODIFIER_DENSE_CODE = 2.0     # Code > 20 l├¡neas
MODIFIER_REPETITION = -1.0    # Concepto que ya se vio antes (interleavig)
MODIFIER_RESET = -3.0         # Socr├ítica/demo tras teor├¡a pesada

# Umbrales
FATIGUE_THRESHOLD = 50         # Carga acumulada donde la atenci├│n cae
CRITICAL_THRESHOLD = 75        # Riesgo alto de sobrecarga
AVG_MINUTES_PER_SLIDE = 2.0   # Estimaci├│n conservadora


# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# AN├üLISIS DESDE PLAN JSON
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def analyze_from_plan(slides: list[dict]) -> list[dict]:
    ...
    for i, slide in enumerate(slides):
        ...
        results.append({
            ...
            "time_min": time_min,
            "zone": (
                "­ƒƒó OK" if cumulative < FATIGUE_THRESHOLD
                else "­ƒƒí Fatiga" if cumulative < CRITICAL_THRESHOLD
                else "­ƒö┤ Sobrecarga"
            ),
        })
...
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
# AN├üLISIS DESDE filminas.md (fallback)
# ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
def analyze_from_filminas_md(filminas_path: Path) -> list[dict]:
    ...
    type_patterns = {
        ...
        r"tipo:\s*socr[a├í]tica|\?": "socratica",
...
def generate_report(analyses: list[dict], topic_id: str,
    ...
    lines = [
        f"# Presupuesto Cognitivo ÔÇö {topic_id}",
        f"**Generado:** {now}",
    ...
    if analyses:
        ...
        lines.append(f"         {'ÔöÇ' * 42}")
        lines.append(f"         0{'ÔöÇ' * 10}Fatiga{'ÔöÇ' * 8}Sobrecarga{'ÔöÇ' * 7}")
    lines.append("```")
    ...
    lines.extend([
        ...
        "## Detalle por Filmina",
        "",
        "| # | ID | Tipo | T├¡tulo | Peso | Mod | Efect | Acum | Min | Zona |",
        "|---|-----|------|--------|------|-----|-------|------|-----|------|",
    ])
    ...
    if critical_slide:
        lines.append(
            f"­ƒö┤ **Sobrecarga alcanzada** en {critical_slide['slide_id']} "
            f"(~min {critical_slide['time_min']}). "
            "Insertar pausa activa, demo o filmina socr├ítica antes de este punto."
        )
    elif fatigue_slide:
        lines.append(
            f"­ƒƒí **Fatiga esperada** a partir de {fatigue_slide['slide_id']} "
            f"(~min {fatigue_slide['time_min']}). "
            "Considerar un attention reset (demo, pregunta, pausa)."
        )
    else:
        lines.append("Ô£à La clase se mantiene dentro del presupuesto cognitivo ideal.")
    ...
    if len(analyses) > 6:
        ...
        if avg_last > avg_first * 1.2:
            lines.append(
                "\nÔÜá´©Å **Patr├│n invertido:** La carga SUBE al final en vez de bajar. "
                "Idealmente la clase debe cerrar con intensidad decreciente (U invertida)."
            )
        else:
            lines.append(
                "\nÔ£à **Patr├│n correcto:** La intensidad disminuye hacia el cierre."
            )
...
def main() -> None:
    ...
    if plan_result.is_ok:
        ...
        if filminas_path.exists():
            ...
            print(f"ERROR: No se encontr├│ plan JSON ni filminas.md en {topic_folder}", file=sys.stderr)
            sys.exit(1)
